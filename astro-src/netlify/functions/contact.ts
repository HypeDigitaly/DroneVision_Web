...
function notificationHtml(lead: ContactLead): string {
  const rows = [
    ...
    ["E-mail", `<a href="mailto:${escapeHtml(lead.email)}" style="color:#D40074">${escapeHtml(lead.email)}</a>`],
  ...
  <tr><td align="center" style="padding:40px 20px">
    <table width="600" cellspacing="0" cellpadding="0" style="background:#111;border-radius:12px;border:1px solid rgba(255,255,255,0.1);max-width:600px">
      ...
      <tr><td style="padding:16px 36px 28px;text-align:center">
        <a href="mailto:${escapeHtml(lead.email)}" style="display:inline-block;padding:12px 28px;background:#D40074;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:600">Odpovedet</a>
      </td></tr>
    </table>
  </td></tr>
</table>
  ...
  <tr><td align="center" style="padding:40px 20px">
    <table width="600" cellspacing="0" cellpadding="0" style="background:#111;border-radius:12px;border:1px solid rgba(255,255,255,0.1);max-width:600px">
      ...
      <tr><td style="padding:28px 36px">
        ...
        <div style="padding:16px;background:rgba(255,255,255,0.04);border-left:3px solid #D40074;border-radius:4px">
